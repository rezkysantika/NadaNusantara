...
public class PlayC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_c);
...
//                Toast.makeText(PlayC.this, "Waktu Habis!", Toast.LENGTH_SHORT).show();
    ...
    private void continueGame3() {
        ...
        lagu3.add(29, R.raw.e4);
        lagu3.add(30, R.raw.e4);
        lagu3.add(31, R.raw.f4);
        lagu3.add(32, R.raw.e4);
        lagu3.add(33, R.raw.d4);
        lagu3.add(34, R.raw.d4);
        lagu3.add(35, R.raw.b3);
        lagu3.add(36, R.raw.c4);
        lagu3.add(37, R.raw.d4);
    ...
    private void continueGame4() {
        ...
        lagu4.add(17, R.raw.b3);
        lagu4.add(18, R.raw.b3);
        lagu4.add(19, R.raw.a4);
        lagu4.add(20, R.raw.f4);
        lagu4.add(21, R.raw.e3);
        lagu4.add(22, R.raw.e4);
        lagu4.add(23, R.raw.a4);
        lagu4.add(24, R.raw.e4);
        lagu4.add(25, R.raw.a4);
        lagu4.add(26, R.raw.b3);
        lagu4.add(27, R.raw.a3);
        lagu4.add(28, R.raw.e4);
        lagu4.add(29, R.raw.a4);
        lagu4.add(30, R.raw.f4);
        lagu4.add(31, R.raw.e4);
        lagu4.add(32, R.raw.e4);
        lagu4.add(33, R.raw.f4);
        lagu4.add(34, R.raw.a4);
        lagu4.add(35, R.raw.b3);
        lagu4.add(36, R.raw.c5);
    ...
    private void endGame() {
        ...
        timer.cancel();
        dialogTryAgain();
//        Toast.makeText(PlayC.this, "Failed!", Toast.LENGTH_SHORT).show();
    ...
    public void dialogGuess1() {
        ...
        opsi2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(PlayC.this, "Jawaban salah, ulangi lagi", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
    ...
    public void dialogGuess2() {
        ...
        final Button opsi4 = dialog.findViewById(R.id.opsi4);
        opsi4.setText("Ampar-Ampar Pisang");
        opsi4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(PlayC.this, "Jawaban salah, ulangi lagi", Toast.LENGTH_SHORT).show();
    ...
    public void dialogGuess5() {
        ...
        final Button opsi3 = dialog.findViewById(R.id.opsi3);
        opsi3.setText("Naik-Naik ke Puncak Gunung");
        opsi3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(PlayC.this, "Jawaban salah, ulangi lagi", Toast.LENGTH_SHORT).show();
